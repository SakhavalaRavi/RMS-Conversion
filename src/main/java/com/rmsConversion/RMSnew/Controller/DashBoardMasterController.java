...
import com.rmsConversion.RMSnew.Model.*;
import com.rmsConversion.RMSnew.Service.*;
...
public class DashBoardMasterController {
	...
	@RequestMapping(value = "/allocateRedirectUrl", produces = { "application/json" }, method = RequestMethod.POST)
	...
	@RequestMapping(value = "/getAllocatedMenuById/{id}", produces = {

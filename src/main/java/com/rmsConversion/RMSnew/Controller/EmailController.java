...
import com.rmsConversion.RMSnew.Service.EmailService;
...
public class EmailController {
	...
	@RequestMapping(value = "/emailtemp/{userid}", produces = { "application/json" }, method = RequestMethod.GET)
	public List<EmailTemplate> getemaillistByuserid(@PathVariable Long userid) {
		return emlSerive.getemaillistByUser_id(userid);
	}

	@RequestMapping(method = RequestMethod.POST, value = "/saveemailtemplate")
	...
	@RequestMapping(method = RequestMethod.GET, value = "/updateemailtemplate/{eid}/{templatename}/{templatetype}/{email}/{emailsubject}/{userid}/{role}")
	...
	@RequestMapping(method = RequestMethod.GET, value = "/deletemailtemplate/{eid}")
